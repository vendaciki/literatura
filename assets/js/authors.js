const Authors = [
    ...
    { label: "Puškin, Alexandr Sergejevič ", href: "../html/.html" },
    { label: "Poe, Edgar Alan", href: "../html/.html" },
    ...
    { label: "Remarque, Erich Maria ", href: "../html/.html" },
    { label: "Camus, Albert ", href: "../html/.html" },
    { label: "Hemingway, Ernest ", href: "../html/.html" },
    ...
    { label: "Saint-Exupéry, Antoine de ", href: "../html/.html" },
